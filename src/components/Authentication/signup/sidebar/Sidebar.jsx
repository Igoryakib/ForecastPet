  ...
  return <div className={styles.sidebar}>
          ...
          <div className={styles.header} >
            ...
            <p className={styles.subheading}>
              Розкрий світ прогнозів погоди, які ніколи не брешуть та доєднайся
              до ком’юніті однодумців
            </p>
          </div>
          <div>
            {clients.map((client, i) => i+1 === activeFeedback ? <Feedback key={i} client={clients[activeFeedback-1]} /> : '')}
            <FeedbackNav number={clients.length} setActiveFeedback={setActiveFeedback} activeFeedback={activeFeedback} />
          </div>
        </div>
